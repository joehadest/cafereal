  ...
  return (
    <div className="print-receipt print:block bg-white text-black font-mono font-bold" style={{ width: '100%', maxWidth: '100%', margin: '0', padding: '2mm 1mm', boxSizing: 'border-box', overflow: 'visible', wordWrap: 'break-word', display: 'block', visibility: 'visible', pageBreakInside: 'auto', height: 'auto', minHeight: 'auto', lineHeight: '1.3', fontSize: '15px', fontWeight: 'bold' }}>
      ...
      <div className="text-center mb-2" style={{ borderTop: '1px solid #000', borderBottom: '1px solid #000', padding: '2px 0' }}>
        <p className="font-bold uppercase" style={{ fontSize: '16px', fontWeight: 'bold' }}>COMPROVANTE DE PEDIDO</p>
      </div>

      {/* Informações do Pedido */}
      <div className="mb-2 pb-2" style={{ borderBottom: '1px dashed #000' }}>
        <div className="flex justify-between items-center mb-1">
          <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>PEDIDO:</span>
          <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>#{order.id.slice(0, 8).toUpperCase()}</span>
        </div>
        <div className="flex justify-between items-center mb-1">
        ...
        <div className="flex justify-between items-center mb-1">
          <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>Tipo:</span>
        ...
        <div className="flex justify-between items-center">
          <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>Status:</span>
      ...
      {(order.customer_name || order.payment_method || (isDelivery && order.customer_phone)) && (
        <div className="mb-2 pb-2" style={{ borderBottom: '1px dashed #000' }}>
          <p className="font-bold uppercase mb-1" style={{ fontSize: '16px', fontWeight: 'bold' }}>DADOS DO CLIENTE</p>
          {order.customer_name && (
          ...
          {isDelivery && order.reference_point && (
            <div>
              <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>Ref.: </span>
              <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
              ...
              <div key={item.id} className={index < order.order_items.length - 1 ? "mb-2 pb-2" : ""} style={index < order.order_items.length - 1 ? { borderBottom: '1px dashed #ccc' } : {}}>
                ...
                {item.variety_name && (
                  <div className="ml-2 mb-0.5">
                    <span className="font-bold" style={{ fontSize: '15px', fontWeight: 'bold' }}>Tam: </span>
