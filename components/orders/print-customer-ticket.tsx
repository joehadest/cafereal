...
export function PrintCustomerTicket({ order, restaurantInfo, deliveryZoneName, newItemIds }: PrintCustomerTicketProps) {
  const isDelivery = order.order_type === "delivery"
  const timestamp = new Date(order.created_at)

  return (
    <div className="print-customer hidden print:block bg-white text-black font-mono overflow-visible font-bold" style={{ width: '100%', maxWidth: '100%', margin: '0', padding: '3mm 2mm', boxSizing: 'border-box', pageBreakInside: 'auto', height: 'auto', minHeight: 'auto', lineHeight: '1.4', fontSize: '13px', fontWeight: 'bold' }}>
      ...
      <div className="text-center mb-2" style={{ borderTop: '1px solid #000', borderBottom: '1px solid #000', padding: '2px 0', backgroundColor: '#e8e8e8' }}>
        <p className="font-bold uppercase" style={{ fontSize: '14px', fontWeight: 'bold' }}>COMANDA DO CLIENTE</p>
      </div>
      ...
      <div className="mb-2 pb-2" style={{ borderBottom: '1px dashed #000', backgroundColor: '#fafafa', padding: '3px 2px', borderRadius: '2px' }}>
        ...
        {!isDelivery && (
          <div className="flex justify-between items-center">
            <span className="font-bold" style={{ fontSize: '13px', fontWeight: 'bold' }}>Local:</span>
              ...
              <div key={item.id} className={index < order.order_items.length - 1 ? "mb-2 pb-2" : ""} style={index < order.order_items.length - 1 ? { borderBottom: '1px dashed #ccc' } : {}}>
                ...
                {item.variety_name && (
                  <div className="ml-2 mb-0.5" style={{ backgroundColor: '#f0f0f0', padding: '1px 3px', borderRadius: '1px' }}>
                    <span className="font-bold" style={{ fontSize: '13px', fontWeight: 'bold' }}>Tamanho: </span>
