  ...
  const handlePrint = () => {
    ...
    style.innerHTML = `
      @media print {
        ...
        #print-container, 
        #print-container *, 
        #print-container .print-kitchen,
        #print-container .print-kitchen *,
        #print-container .print-receipt,
        #print-container .print-receipt * { 
          visibility: visible !important; 
          display: block !important;
        }
        #print-container .hidden,
        #print-container .print-kitchen.hidden,
        #print-container .print-receipt.hidden {
          display: block !important;
          visibility: visible !important;
        }
        #print-container { 
    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl">Imprimir Pedido</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            {/* Seleção de Pedido */}
            <div>
              <Label className="text-base font-semibold mb-3 block">Selecionar Pedido</Label>
                    ...
                    {filteredOrders.map((order) => (
                      <div
                        ...
                        className={`flex items-center space-x-3 p-3 hover:bg-slate-50 cursor-pointer transition-colors ${
                          selectedOrder === order.id ? "bg-slate-100" : ""
                        }`}
