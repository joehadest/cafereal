      ...
      <div className="w-full max-w-sm">
        <Card className="border-purple-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-purple-900">Conta Criada com Sucesso!</CardTitle>
            <CardDescription className="text-purple-700">Verifique seu email para confirmar</CardDescription>
          </CardHeader>
