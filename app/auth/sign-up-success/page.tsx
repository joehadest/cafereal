      ...
      <div className="w-full max-w-sm">
        <Card className="border-orange-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-orange-900">Conta Criada com Sucesso!</CardTitle>
            <CardDescription className="text-orange-700">Verifique seu email para confirmar</CardDescription>
          </CardHeader>
